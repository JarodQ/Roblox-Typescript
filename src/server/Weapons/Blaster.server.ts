...
import { validateShootArguments } from "server/Weapons/Validate/validateShootArguments";
import * as validateShot from "server/Weapons/Validate/validateShot";
import { validateTag } from "server/Weapons/Validate/validateTag";
import { validateReload } from "server/Weapons/Validate/validateReload";
